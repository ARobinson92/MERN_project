...
function Dwayne(props) {
    ...
    const [values, setValues] = useState([
        {
            label: "value 1",
            value: "Value 1 means you are temperemental",
            freq: 0,
        },
        ...
        {
            label: "value 4",
            value: "Value 4 means you are a charming one",
            freq: 0,
        },
        {
            label: "value 5",
            value: "Value 5 means you DID STOLE THOSE COOKIES",
            freq: 0,
        },
    ]);
    ...
    return (
        <View style={styles.appPageContainer}>
            ...
            <RadioForm
                ...
                onPress={handlePress}
            />
            {display ? <Text>SHOW THIS: {display}</Text> : null}
            ...
            <Text style={styles.normal}>
                Value 1 has been chosen: {values[0]["freq"]} times
            </Text>
            <Text style={styles.normal}>
                Value 2 has been chosen: {values[1]["freq"]} times
            </Text>
            <Text style={styles.normal}>
                Value 3 has been chosen: {values[2]["freq"]} times{" "}
            </Text>
            <Text style={styles.normal}>
                Value 4 has been chosen: {values[3]["freq"]} times
            </Text>
            <Text style={styles.normal}>
                Value 5 has been chosen: {values[4]["freq"]} times
            </Text>
            <Text style={styles.normal}>
                ***************************************
            </Text>
            ...
            {/* {valuesList.map((value, index) => {
                <View>
                    ...
                    <Text style={styles.dwayne}>{value.value}</Text>
