    ...
    <View style={styles.container}>
      ...
      <View style={styles.appBox}>
        ...
        <Text style={styles.paragraph}>
          Inspired by the work of best-selling author Mark Manson, our goal is
          to help you uncover the values most important to you and use the power
          of reflection to acheive your goals.
        </Text>
      </View>
      <View style={styles.bottomBox}>
        ...
        <Text style={styles.attribution}>
          Logo designed by litonmee (Image #27510217 at VectorStock.com)
        </Text>
      </View>
    </View>
  );
